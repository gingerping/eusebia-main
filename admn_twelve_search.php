...
function renderDocs_twelve($docsJson) {
...
function renderStatus_twelve($status) {
...
function renderActions_twelve($id_col_val, $id_resident, $status, $fname, $lname, $mi, $prefix = '') {
    ...
    <?php if ($status !== 'Approved' && $status !== 'Rejected'): ?>
        <form action="" method="post" style="display:inline;" onsubmit="return confirmApprove_twelve(this);">
            <input type="hidden" name="id_twelve" value="<?= $id_col_val ?>">
        ...
        <button type="button" class="btn btn-danger btn-sm mb-1" style="border-radius:30px;"
            onclick="openRejectModal_twelve(<?= $id_col_val ?>, '<?= addslashes($fullName) ?>')">
...
<?php if (isset($_POST['search_twelve'])): $keyword = $_POST['keyword']; ?>
...
<div class="table-responsive" style="width:100%;overflow-x:auto;">
    <table class="table table-hover text-center table-bordered" style="min-width:1200px;">
        ...
        <?php
            $kw   = "%$keyword%";
            $stmt = $conn->prepare("SELECT * FROM `tbl_twelve` WHERE `lname` LIKE ? OR `fname` LIKE ? OR `id_resident` LIKE ? OR `lrn` LIKE ?");
        ...
        <tr>
            ...
            <td style="min-width:145px;"><?php renderDocs_twelve($view['documents'] ?? ''); ?></td>
            <td><?php renderStatus_twelve($sStatus); ?></td>
            <td style="min-width:220px;">
                <?php renderActions_twelve($view['id_twelve'], $view['id_resident'], $sStatus,
            ...
            <div class="modal-dialog modal-md modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-left">
                        ...
                        <p><strong>Status:</strong> <?php renderStatus_twelve($sStatus); ?></p>
...
<div class="table-responsive" style="width:100%;overflow-x:auto;">
    ...
    ?>
        <tr>
            ...
            <td style="min-width:145px;"><?php renderDocs_twelve($row['documents'] ?? ''); ?></td>
            <td><?php renderStatus_twelve($rStatus); ?></td>
            <td style="min-width:220px;">
                <?php renderActions_twelve($row['id_twelve'], $row['id_resident'], $rStatus,
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-left">
                        ...
                        <hr style="border:2px solid black;opacity:1;">
                        <p><strong>Status:</strong> <?php renderStatus_twelve($rStatus); ?></p>
...
function confirmApprove_twelve(form) {
...
function openRejectModal_twelve(id_col_val, studentName) {
