<?php
    ...
    $view = $studenteusebia->view_twelve_gas();
?>
...
<div class="container-fluid">
    ...
    <div class="d-flex align-items-center justify-content-between mb-3">
        <div>
            <h4 class="mb-0 font-weight-bold text-dark">
                <i class="fas fa-book mr-2" style="color:#0b2b5c;"></i>Grade 12 — GAS Student List
            </h4>
    ...
    <?php
    function renderDocs_gastwelve($docsJson) {
    ...
    function renderStatus_gastwelve($status) {
    ...
    function renderActions_gastwelve($id_col_val, $id_student, $status, $fname, $lname, $mi) {
        ...
        <?php if ($status !== 'Approved' && $status !== 'Rejected'): ?>
            <form action="" method="post" style="display:inline;" onsubmit="return confirmApprove_gastwelve(this);">
                <input type="hidden" name="id_twelve" value="<?= $id_col_val ?>">
            ...
            <button type="button" class="btn btn-danger btn-sm mb-1" style="border-radius:30px;"
                onclick="openRejectModal_gastwelve(<?= $id_col_val ?>, '<?= addslashes($fullName) ?>')">
    ...
    <div class="card shadow-sm">
        <div class="card-header py-2 d-flex align-items-center justify-content-between"
            ...
            <span class="text-white font-weight-bold">
                <i class="fas fa-table mr-1"></i> GAS Enrollees
            </span>
        </div>
                ...
                <table class="table table-hover table-bordered table-sm mb-0" id="studentsTable" style="font-size:.84rem;">
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="min-width:145px;"><?php renderDocs_gastwelve($row['documents'] ?? ''); ?></td>
                            <td style="min-width:150px;"><?php render_ai_review_cell($row['ai_analysis'] ?? null, 'twelve', $row['id_twelve']); ?></td>
                            <td><?php renderStatus_gastwelve($rStatus); ?></td>
                            <td style="min-width:220px;">
                                <?php renderActions_gastwelve($row['id_twelve'], $row['id_student'], $rStatus,
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body text-left">
                                        ...
                                        <hr style="border:2px solid black;opacity:1;">
                                        <p><strong>Status:</strong> <?php renderStatus_gastwelve($rStatus); ?></p>
...
function confirmApprove_gastwelve(form) {
...
function openRejectModal_gastwelve(id_col_val, studentName) {
