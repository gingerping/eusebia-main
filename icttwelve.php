...
<div class="container-fluid">
    ...
    <div class="d-flex align-items-center justify-content-between mb-3">
        <div>
            <h4 class="mb-0 font-weight-bold text-dark">
                <i class="fas fa-laptop-code mr-2" style="color:#0b2b5c;"></i>Grade 12 — TVL-ICT Student List
            </h4>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content" style="border-radius:14px;overflow:hidden;">
                ...
                <form id="rejectForm" action="" method="POST">
                    <input type="hidden" name="id_twelve" id="rejectIdTwelve" value="">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" name="reject_twelve" class="btn btn-danger">
    ...
    <?php
    function renderDocs_icttwelve($docsJson) {
    ...
    function renderStatus_icttwelve($status) {
    ...
    function renderActions_icttwelve($id_col_val, $id_student, $status, $fname, $lname, $mi) {
        $fullName = htmlspecialchars($lname.', '.$fname.' '.$mi);
        $modalId  = 'viewModal'.$id_student;
        ?>
        ...
        <form action="" method="post" style="display:inline;">
            <input type="hidden" name="id_twelve" value="<?= $id_col_val ?>">
            <button class="btn btn-secondary btn-sm mb-1" type="submit" name="delete_twelve" style="border-radius:30px;">
                <i class="fas fa-archive mr-1"></i>Archive
            </button>
        </form>
        <?php if ($status !== 'Approved' && $status !== 'Rejected'): ?>
            <form action="" method="post" style="display:inline;" onsubmit="return confirmApprove_icttwelve(this);">
                <input type="hidden" name="id_twelve" value="<?= $id_col_val ?>">
                <input type="hidden" name="approve_twelve" value="1">
            ...
            <button type="button" class="btn btn-danger btn-sm mb-1" style="border-radius:30px;"
                onclick="openRejectModal_icttwelve(<?= $id_col_val ?>, '<?= addslashes($fullName) ?>')">
    ...
    <div class="card shadow-sm">
        <div class="card-header py-2 d-flex align-items-center justify-content-between"
            ...
            <span class="text-white font-weight-bold">
                <i class="fas fa-table mr-1"></i> TVL-ICT Enrollees
            </span>
        </div>
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-hover table-bordered table-sm mb-0" id="studentsTable" style="font-size:.84rem;">
                    ...
                    <?php if (is_array($view) && count($view) > 0): foreach ($view as $row):
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="min-width:145px;"><?php renderDocs_icttwelve($row['documents'] ?? ''); ?></td>
                            <td style="min-width:150px;"><?php render_ai_review_cell($row['ai_analysis'] ?? null, 'twelve', $row['id_twelve']); ?></td>
                            <td><?php renderStatus_icttwelve($rStatus); ?></td>
                            <td style="min-width:220px;">
                                <?php renderActions_icttwelve($row['id_twelve'], $row['id_student'], $rStatus,
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body text-left">
                                        ...
                                        <hr style="border:2px solid black;opacity:1;">
                                        <p><strong>Status:</strong> <?php renderStatus_icttwelve($rStatus); ?></p>
...
function confirmApprove_icttwelve(form) {
    var row  = form.closest('tr');
    var name = row ? row.cells[2].innerText.trim() : 'this student';
    Swal.fire({
...
function openRejectModal_icttwelve(id_col_val, studentName) {
    document.getElementById('rejectIdTwelve').value = id_col_val;
