<?php
    ...
    $view = $studenteusebia->view_eleven_he();
?>
...
<div class="container-fluid">
    ...
    <div class="d-flex align-items-center justify-content-between mb-3">
        <div>
            <h4 class="mb-0 font-weight-bold text-dark">
                <i class="fas fa-utensils mr-2" style="color:#0b2b5c;"></i>Grade 11 — TVL-HE Student List
            </h4>
    ...
    <?php
    function renderDocs_heeleven($docsJson) {
    ...
    function renderStatus_heeleven($status) {
    ...
    function renderActions_heeleven($id_col_val, $id_student, $status, $fname, $lname, $mi) {
        ...
        <?php if ($status !== 'Approved' && $status !== 'Rejected'): ?>
            <form action="" method="post" style="display:inline;" onsubmit="return confirmApprove_heeleven(this);">
                <input type="hidden" name="id_eleven" value="<?= $id_col_val ?>">
            ...
            <button type="button" class="btn btn-danger btn-sm mb-1" style="border-radius:30px;"
                onclick="openRejectModal_heeleven(<?= $id_col_val ?>, '<?= addslashes($fullName) ?>')">
                ...
                <table class="table table-hover table-bordered table-sm mb-0" id="studentsTable" style="font-size:.84rem;">
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="min-width:145px;"><?php renderDocs_heeleven($row['documents'] ?? ''); ?></td>
                            <td style="min-width:150px;"><?php render_ai_review_cell($row['ai_analysis'] ?? null, 'eleven', $row['id_eleven']); ?></td>
                            <td><?php renderStatus_heeleven($rStatus); ?></td>
                            <td style="min-width:220px;">
                                <?php renderActions_heeleven($row['id_eleven'], $row['id_student'], $rStatus,
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body text-left">
                                        ...
                                        <hr style="border:2px solid black;opacity:1;">
                                        <p><strong>Status:</strong> <?php renderStatus_heeleven($rStatus); ?></p>
...
function confirmApprove_heeleven(form) {
...
function openRejectModal_heeleven(id_col_val, studentName) {
