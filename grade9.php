...
$eusebia->create_nine(); // handles Grade 9 enrollment submission
...
<head>
    ...
    <title>EPANHS | Grade 9 Enrollment</title>
...
<!-- MODAL: Grade 9 Enrollment Form (with course selection) -->
        ...
        <div class="modal-content">
            <form method="post" class="was-validated">
                ...
                <div class="modal-body">
                    <!-- School Year & Course Selection (special for Grade 9) -->
                    ...
                    <div class="form-section">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4"><input name="email" type="email" class="form-control" placeholder="Email Address" required></div>
                ...
                <div class="modal-footer bg-light">
                    ...
                    <button type="submit" name="create_nine" class="btn btn-enroll rounded-pill px-5">Submit Enrollment</button>
                </div>
            </form>
        </div>
    </div>
