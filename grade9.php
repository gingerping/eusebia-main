...
<head>
    ...
    <title>EPAMNHS | Grade 10 Enrollment</title>
...
<div class="hero-enroll">
    <div class="container">
        ...
        <h1 class="hero-title">Grade 9 Enrollment</h1>
    ...
    <div class="row g-4">
        <div class="col-md-4" data-aos="fade-up" data-aos-delay="50">
            <div class="step-card">
                ...
                <p class="text-secondary">Gather all necessary documents and information for Grade 9 admission.</p>
            </div>
        </div>
...
<div class="container text-center my-5" data-aos="zoom-in">
    <button type="button" class="btn btn-enroll" data-bs-toggle="modal" data-bs-target="#enrollmentModal">
        <i class="fas fa-pen-alt me-2"></i> Open Grade 9 Form
    </button>
</div>
        ...
        <div class="modal-content">
            <form id="enrollForm" method="post" enctype="multipart/form-data" class="was-validated">
                ...
                <div class="modal-header">
                    <h5 class="modal-title fw-bold" id="enrollmentModalLabel"><i class="fas fa-edit me-2"></i>Grade 9 Enrollment Form</h5>
                ...
                <div class="modal-footer bg-light">
                    ...
                    <button type="submit" name="create_nine" class="btn btn-modal-submit rounded-pill px-4">
