                ...
                <tr>
                    <td>    
                        <form action="" method="post">
                            <a href="update_student_form.php?id_student=<?= $view['id_student'];?>" class="btn btn-success" style="width: 90px; font-size: 17px; border-radius:30px; margin-bottom: 2px;">  Update </a>
                            <input type="hidden" name="id_student" value="<?= $view['id_student'];?>">
                            <button class="btn btn-danger" type="submit" name="delete_student" style="width: 90px; font-size: 17px; border-radius:30px;"> Archive </button>
                        </form>
                    </td>
                    <td> <?= $view['email'];?> </td>
                    <td> <?= $view['lname'];?> </td>
