  ...
  <link rel="icon" type="image/png" sizes="192x192" href="icons/pwa/icon-192x192.png">
    ...
    <body>
        <div class="container-fluid"> 
            ...
            <div class="row"> 
                <div class="col">
                <form action="student_crud_search.php" method="get"> 
                    ...
                    <form action="" method="post">
                        ...
                        <?php if(is_array($view)) {?>
                            ...
                            <tr>
                                ...
                                <td>    
                                <form action="" method="post">
                                    <a href="student_crud.php?email=<?= $view['email'];?>" class="btn btn-primary">  Update </a>
                                    <input type="hidden" name="email" value="<?= $view['email'];?>">
                                    <button class="btn btn-danger" type="submit" name="delete_student"> Remove </button>
                                    </form>
                                </td>
                            </tr>
                            <?php }?>
            ...
            <div class="row"> 
                <div class="col"> 
                    ...
                    <div class="row">
                        ...
                        <button class="btn btn-primary" type="submit" name="add_student"> Add </button>
                    </form>
                </div>
