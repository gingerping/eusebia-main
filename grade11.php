...
<!-- MODAL: Grade 11 Enrollment Form (with course selection) -->
        ...
        <div class="modal-content">
            <form method="post" enctype="multipart/form-data" class="was-validated">
                ...
                <div class="modal-body">
                    <!-- School Year & Course Selection (special for Grade 11) -->
                ...
                <div class="modal-footer bg-light">
                    ...
                    <button type="submit" name="create_eleven" class="btn btn-enroll rounded-pill px-5">Submit Enrollment</button>
                </div>
            </form>
        </div>
    </div>
