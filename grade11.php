...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* ========== STANDALONE MODAL SUBMIT BUTTON ========== */
        .btn-modal-submit {
            background: linear-gradient(135deg, #0b2b5c, #1f5a9e);
            border: none;
            color: white;
        ...
        .form-control, .form-select {
            ...
            padding: 0.6rem 1rem;
            font-size: 16px; /* Prevents auto screen zoom inside iOS Safari */
        }
        ...
        /* Validation border override presets */
        ...
        /* ========== RESPONSIVE DEVICE VIEWPORTS OVERRIDES ========== */
        @media (max-width: 768px) {
            ...
            /* Responsive dual symmetrical flex alignment row buttons */
            .modal-footer {
...
<div class="hero-enroll">
    <div class="container">
        ...
        <h1 class="hero-title">Grade 11 Enrollment</h1>
    ...
    <div class="row g-4">
        <div class="col-md-4" data-aos="fade-up" data-aos-delay="50">
            <div class="step-card">
                ...
                <p class="text-secondary">Gather all necessary documents and information for Grade 11 admission.</p>
            </div>
        </div>
...
<div class="container text-center my-5" data-aos="zoom-in">
    <button type="button" class="btn btn-enroll" data-bs-toggle="modal" data-bs-target="#enrollmentModal">
        <i class="fas fa-pen-alt me-2"></i> Open Grade 11 Form
    </button>
</div>
        ...
        <div class="modal-content">
            <form id="enrollForm" method="post" enctype="multipart/form-data" class="was-validated">
                ...
                <div class="modal-header">
                    <h5 class="modal-title fw-bold" id="enrollmentModalLabel"><i class="fas fa-edit me-2"></i>Grade 11 Enrollment Form</h5>
                ...
                <div class="modal-footer bg-light">
                    ...
                    <button type="submit" name="create_eleven" class="btn btn-modal-submit rounded-pill px-4">
...
<script>
    ...
    // Sync student type input select parameters
    ...
    // Back to top scrolling animations
    ...
    // Custom browser scroll handling to first invalid component layout
    ...
    // Clear and restore data attributes on hidden modal closure event frames
    ...
    // ========== DOCUMENT UPLOAD DRAG/DROP INTERACTION ==========
