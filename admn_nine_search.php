...
function renderActions_nine($id_col_val, $id_student, $status, $fname, $lname, $mi, $prefix = '') {
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right actions-dropdown-menu" aria-labelledby="<?= $ddId ?>" data-boundary="window">
            ...
            <form action="" method="post">
                ...
                <button class="dropdown-item item-archive" type="submit" name="delete_nine">
            ...
            <?php if ($status !== 'Approved' && $status !== 'Rejected'): ?>
                ...
                <form action="" method="post" onsubmit="return confirmApprove_nine(this);">
                    <input type="hidden" name="id_nine" value="<?= $id_col_val ?>">
...
<div class="card shadow-sm">
    <div class="card-header py-2 d-flex align-items-center justify-content-between"
        ...
        <span class="text-white font-weight-bold">
            <i class="fas fa-table mr-1"></i> Grade 9 Enrollees
        </span>
    </div>
    ...
    ?>
        <tr>
            ...
            <td style="min-width:150px;"><?php render_ai_review_cell($row['ai_analysis'] ?? null, 'nine', $row['id_nine']); ?></td>
            <td><?php renderStatus_nine($rStatus); ?></td>
            <td style="min-width:220px;">
                <?php renderActions_nine($row['id_nine'], $row['id_student'], $rStatus,
