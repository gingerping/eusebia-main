    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content" style="border-radius:14px;overflow:hidden;">
            ...
            <form id="rejectForm" action="" method="POST">
                <input type="hidden" name="id_nine" id="rejectIdNine" value="">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="reject_nine" class="btn btn-danger">
...
function renderDocs_nine($docsJson) {
...
function renderStatus_nine($status) {
...
function renderActions_nine($id_col_val, $id_resident, $status, $fname, $lname, $mi, $prefix = '') {
    ...
    <form action="" method="post" style="display:inline;">
        <input type="hidden" name="id_nine" value="<?= $id_col_val ?>">
        <button class="btn btn-secondary btn-sm mb-1" type="submit" name="delete_nine" style="border-radius:30px;">
            <i class="fas fa-archive mr-1"></i>Archive
        </button>
    </form>
    <?php if ($status !== 'Approved' && $status !== 'Rejected'): ?>
        <form action="" method="post" style="display:inline;" onsubmit="return confirmApprove_nine(this);">
            <input type="hidden" name="id_nine" value="<?= $id_col_val ?>">
            <input type="hidden" name="approve_nine" value="1">
        ...
        <button type="button" class="btn btn-danger btn-sm mb-1" style="border-radius:30px;"
            onclick="openRejectModal_nine(<?= $id_col_val ?>, '<?= addslashes($fullName) ?>')">
...
<?php if (isset($_POST['search_nine'])): $keyword = $_POST['keyword']; ?>
...
<div class="table-responsive" style="width:100%;overflow-x:auto;">
    <table class="table table-hover text-center table-bordered" style="min-width:1200px;">
        ...
        <?php
            $kw   = "%$keyword%";
            $stmt = $conn->prepare("SELECT * FROM `tbl_nine` WHERE `lname` LIKE ? OR `fname` LIKE ? OR `id_resident` LIKE ? OR `lrn` LIKE ?");
        ...
        <tr>
            ...
            <td style="min-width:145px;"><?php renderDocs_nine($view['documents'] ?? ''); ?></td>
            <td><?php renderStatus_nine($sStatus); ?></td>
            <td style="min-width:220px;">
                <?php renderActions_nine($view['id_nine'], $view['id_resident'], $sStatus,
            ...
            <div class="modal-dialog modal-md modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-left">
                        ...
                        <p><strong>Status:</strong> <?php renderStatus_nine($sStatus); ?></p>
...
<div class="table-responsive" style="width:100%;overflow-x:auto;">
    ...
    ?>
        <tr>
            ...
            <td style="min-width:145px;"><?php renderDocs_nine($row['documents'] ?? ''); ?></td>
            <td><?php renderStatus_nine($rStatus); ?></td>
            <td style="min-width:220px;">
                <?php renderActions_nine($row['id_nine'], $row['id_resident'], $rStatus,
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-left">
                        ...
                        <hr style="border:2px solid black;opacity:1;">
                        <p><strong>Status:</strong> <?php renderStatus_nine($rStatus); ?></p>
...
function confirmApprove_nine(form) {
...
function openRejectModal_nine(id_col_val, studentName) {
    document.getElementById('rejectIdNine').value = id_col_val;
