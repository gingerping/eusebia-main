...
function renderActions_ten($id_col_val, $id_resident, $status, $fname, $lname, $mi, $prefix = '') {
    ...
    <form action="" method="post" style="display:inline;">
        ...
        <button class="btn btn-secondary btn-sm mb-1" type="submit" name="delete_ten" style="border-radius:30px;">
            <i class="fas fa-archive mr-1"></i>Archive
        </button>
    </form>
    <?php if ($status !== 'Approved' && $status !== 'Rejected'): ?>
        <form action="" method="post" style="display:inline;" onsubmit="return confirmApprove_ten(this);">
            <input type="hidden" name="id_ten" value="<?= $id_col_val ?>">
...
<?php if (isset($_POST['search_ten'])): $keyword = $_POST['keyword']; ?>
...
<div class="table-responsive" style="width:100%;overflow-x:auto;">
    <table class="table table-hover text-center table-bordered" style="min-width:1200px;">
        ...
        <?php
            $kw   = "%$keyword%";
            $stmt = $conn->prepare("SELECT * FROM `tbl_ten` WHERE `lname` LIKE ? OR `fname` LIKE ? OR `id_resident` LIKE ? OR `lrn` LIKE ?");
        ...
        <tr>
            ...
            <td style="min-width:145px;"><?php renderDocs_ten($view['documents'] ?? ''); ?></td>
            <td><?php renderStatus_ten($sStatus); ?></td>
            <td style="min-width:220px;">
                <?php renderActions_ten($view['id_ten'], $view['id_resident'], $sStatus,
            ...
            <div class="modal-dialog modal-md modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-left">
                        ...
                        <p><strong>Status:</strong> <?php renderStatus_ten($sStatus); ?></p>
...
<div class="table-responsive" style="width:100%;overflow-x:auto;">
    ...
    ?>
        <tr>
            ...
            <td style="min-width:220px;">
                <?php renderActions_ten($row['id_ten'], $row['id_resident'], $rStatus,
