...
function renderActions_ten($id_col_val, $id_student, $status, $fname, $lname, $mi, $prefix = '') {
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right actions-dropdown-menu" aria-labelledby="<?= $ddId ?>" data-boundary="window">
            ...
            <?php if ($status !== 'Approved' && $status !== 'Rejected'): ?>
                ...
                <form action="" method="post" onsubmit="return confirmApprove_ten(this);">
                    <input type="hidden" name="id_ten" value="<?= $id_col_val ?>">
...
<div class="card shadow-sm">
    <div class="card-header py-2 d-flex align-items-center justify-content-between"
        ...
        <span class="text-white font-weight-bold">
            <i class="fas fa-table mr-1"></i> Grade 10 Enrollees
        </span>
    </div>
