...
<head>
    ...
    <title>EPANHS | Grade 10 Enrollment</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Default validation styling rules overrides */
        ...
        @media (max-width: 768px) {
            ...
            /* Symmetrical dual configuration buttons on mobiles */
            .modal-footer {
...
<div class="hero-enroll">
    <div class="container">
        ...
        <h1 class="hero-title">Grade 10 Enrollment</h1>
    ...
    <div class="row g-4">
        <div class="col-md-4" data-aos="fade-up" data-aos-delay="50">
            <div class="step-card">
                ...
                <p class="text-secondary">Gather all necessary documents and information for Grade 10 admission.</p>
            </div>
        </div>
        <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
            <div class="step-card">
                ...
                <p class="text-secondary">Select your TLE specialization / course and fill the online form accurately.</p>
            </div>
        </div>
...
<div class="container text-center my-5" data-aos="zoom-in">
    <button type="button" class="btn btn-enroll" data-bs-toggle="modal" data-bs-target="#enrollmentModal">
        <i class="fas fa-pen-alt me-2"></i> Open Grade 10 Form
    </button>
</div>
        ...
        <div class="modal-content">
            <form id="enrollForm" method="post" enctype="multipart/form-data" class="was-validated">
                ...
                <div class="modal-header">
                    <h5 class="modal-title fw-bold" id="enrollmentModalLabel"><i class="fas fa-edit me-2"></i>Grade 10 Enrollment Form</h5>
                    ...
                    <div id="mainFormFields" style="display:none;">
                        ...
                        <div class="form-section">
                            <div class="row g-3">
                                ...
                                <div class="col-md-8">
                                    <label class="form-label fw-semibold">TLE Specialization (Course):</label>
                        ...
                        <div class="form-section">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input name="fmi" class="form-control mb-2" placeholder="Middle Name" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="mmi" class="form-control mb-2" placeholder="Middle Name" required>
                ...
                <div class="modal-footer bg-light">
                    ...
                    <button type="submit" name="create_ten" class="btn btn-modal-submit rounded-pill px-4">
...
<script>
    ...
    // Handle smooth fallback scroll focusing to first non-valid element
    ...
    // Reset variables on modal teardown closure
...
function clearForm() {
    var names = ['lrn','school_id','lname','fname','mi','bdate','sex','age','contact','email',
                 'current_address','perm_address','ffname','flname','contact_f',
                 'mlname','mfname','contact_m','lglc','lsa','lysc'];
