<?php 
    ...
    $resident = $id_resident ? $residenteusebia->get_single_eight($id_resident) : null;
?>
    ...
    <div class="row">
        <div class="col">
            <form method="POST">
                ...
                <button class="btn btn-success" name="search_eight" style="width:90px;font-size:17px;border-radius:30px;margin-left:41.5%;">Search</button>
