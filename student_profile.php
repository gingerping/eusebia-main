...
<!-- ========== NAVBAR ========== -->
<?php $active_page = 'profile'; include('student_navbar.php'); ?>
                ...
                <div class="info-section">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input class="form-control" value="<?= htmlspecialchars($student['lname']); ?>" >
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-semibold">First Name</label>
                            <input class="form-control" value="<?= htmlspecialchars($student['fname']); ?>">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-semibold">Middle Name</label>
                            <input class="form-control" value="<?= htmlspecialchars($student['mi']); ?>">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">Email</label>
                            <input class="form-control" value="<?= htmlspecialchars($student['email']); ?>">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label fw-semibold">Sex</label>
                            <input class="form-control" value="<?= htmlspecialchars($student['sex']); ?>">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label fw-semibold">Nationality</label>
                            <input class="form-control" value="<?= htmlspecialchars($student['nationality']); ?>">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">Birth Date</label>
                            <input type="date" class="form-control" name="bdate" value="<?= $student['bdate']; ?>">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">Birth Place</label>
                            <input class="form-control" value="<?= htmlspecialchars($student['bplace']); ?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="info-section">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input class="form-control" type="number" name="age" value="<?= htmlspecialchars($student['age']); ?>">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-semibold">Civil Status</label>
                            <input class="form-control" type="text" name="status" value="<?= htmlspecialchars($student['status']); ?>">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-semibold">Contact No.</label>
                            <input class="form-control" type="tel" name="contact" maxlength="11" pattern="[0-9]{11}" value="<?= htmlspecialchars($student['contact']); ?>">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-semibold">House No.</label>
                            <input class="form-control" type="text" name="houseno" value="<?= htmlspecialchars($student['houseno']); ?>">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-semibold">Street</label>
                            <input class="form-control" type="text" name="street" value="<?= htmlspecialchars($student['street']); ?>">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-semibold">Barangay</label>
                            <input class="form-control" type="text" name="brgy" value="<?= htmlspecialchars($student['brgy']); ?>">
                        </div>
                    </div>
                </div>

                <!-- Hidden fields for household search -->
                <input type="hidden" name="lname" value="<?= htmlspecialchars($student['lname']); ?>">
                <input type="hidden" name="mi" value="<?= htmlspecialchars($student['mi']); ?>">
